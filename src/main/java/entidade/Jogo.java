...
@NamedQueries({
    @NamedQuery(
        name = "Jogo.findMaxValue",
        query = "SELECT GREATEST(j.v1, j.v2, j.v3, j.v4, j.v5) FROM Jogo j"
    )
})
public class Jogo {
	@Id
	...
	public Jogo(Integer id, Date dataCadastro, Integer numeroSorteado, Integer v1, Integer v2, Integer v3, Integer v4,Integer v5) {
		this.id = id;
